...
public class TSpellingComponent extends CSpelling_Component implements ITutorObject, IDataSink, IPublisher, ITutorLogger, IBehaviorManager, IEventSource {
...
//    private HashMap<String,Boolean> _FeatureMap = new HashMap<>();
    ...
    public TSpellingComponent(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
