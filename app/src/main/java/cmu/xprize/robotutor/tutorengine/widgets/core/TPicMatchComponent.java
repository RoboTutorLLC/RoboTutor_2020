...
public class TPicMatchComponent extends CPicMatch_Component implements ITutorObject, IDataSink, IPublisher, ITutorLogger, IBehaviorManager, IEventSource {
    ...
    static final String TAG = "TPicMatchComponent";

    public TPicMatchComponent(Context context) {
        super(context);
    }

    public TPicMatchComponent(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TPicMatchComponent(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void logState(String logData) {
        ...
        RoboTutor.logManager.postTutorState(TCONST.TUTOR_STATE_MSG, "target#picmatch," + logData);
    }
