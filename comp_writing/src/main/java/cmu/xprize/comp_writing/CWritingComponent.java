...
//    protected ImageButton       mScrollLeftButton;
    ...
    // THE ONLY THINGS THAT ARE ACTUALLY IMPORTANT
    ...
    // FOR READING IN THE DATA SOURCE
    ...
    /**
     * What do all of these features do? Who knows!
     */
    private void initializeFeatures() {

        punctuationToFeature = new HashMap<String,String>();
        punctuationToFeature.put(",", WR_FEATURES.FTR_COMMA);
        punctuationToFeature.put(".", WR_FEATURES.FTR_PERIOD);
        punctuationToFeature.put("!", WR_FEATURES.FTR_EXCLAIM);
        punctuationToFeature.put("?", WR_FEATURES.FTR_QUESTION);

        // initialize with four features
        _attemptFTR.add(WR_FEATURES.FTR_ATTEMPT_1);
        _attemptFTR.add(WR_FEATURES.FTR_ATTEMPT_2);
        _attemptFTR.add(WR_FEATURES.FTR_ATTEMPT_3);
        _attemptFTR.add(WR_FEATURES.FTR_ATTEMPT_4);

        //amogh added
        _senAttemptFTR.add(WR_FEATURES.FTR_SEN_ATTEMPT_1);
        _senAttemptFTR.add(WR_FEATURES.FTR_SEN_ATTEMPT_2);
        _senAttemptFTR.add(WR_FEATURES.FTR_SEN_ATTEMPT_3);
        _senAttemptFTR.add(WR_FEATURES.FTR_SEN_ATTEMPT_4);

        _hesitationFTR.add(WR_FEATURES.FTR_HESITATION_1);
        _hesitationFTR.add(WR_FEATURES.FTR_HESITATION_2);
        _hesitationFTR.add(WR_FEATURES.FTR_HESITATION_3);
        _hesitationFTR.add(WR_FEATURES.FTR_HESITATION_4);
//        _hesitationFTR.add(WR_CONST.FTR_HESITATION_5);

        //amogh added to initialise the list for audio features:
        _audioFTR.add(WR_FEATURES.FTR_AUDIO_CAP);
        _audioFTR.add(WR_FEATURES.FTR_AUDIO_LTR);
        _audioFTR.add(WR_FEATURES.FTR_AUDIO_PUNC);
        _audioFTR.add(WR_FEATURES.FTR_AUDIO_SPACE);
        _audioFTR.add(WR_FEATURES.FTR_INSERT);
        _audioFTR.add(WR_FEATURES.FTR_DELETE);
        _audioFTR.add(WR_FEATURES.FTR_REPLACE);
        _audioFTR.add(WR_FEATURES.FTR_PERIOD);
        _audioFTR.add(WR_FEATURES.FTR_COMMA);
        _audioFTR.add(WR_FEATURES.FTR_EXCLAIM);
        _audioFTR.add(WR_FEATURES.FTR_QUESTION);
    ...
    public void onCreate() {
        ...
        mRecognizedScroll = (CLinkedScrollView) findViewById(R.id.Sresponse); // INT_WRITE gesture
        mRecogList = (LinearLayout) findViewById(R.id.Srecognized_glyphs); // INT_WRITE gesture
        // Note: this is used in the GlyphRecognizer project to initialize the sample
        //
        for(int i1 =0 ; i1 < mStimulusData.length ; i1++)
        {
            ...
            // INT_WRITE add gesture listener
            r.setOnTouchListener(new DebugTouchListener("mRecogList.child[" + i1 + "]"));
        ...
        for(int i1 = 0 ; i1 < mStimulusData.length ; i1++)
        {
            ...
            v.setOnTouchListener(new DebugTouchListener("mGlyphList.child[" + i1 + "]"));
        }
    ...
    //  !FTR_AUDIO_SPACE&!FTR_AUDIO_PUNC&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_1|!FTR_AUDIO_SPACE&!FTR_AUDIO_PUNC&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_2|!FTR_AUDIO_SPACE&!FTR_AUDIO_PUNC&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_3
    public void showHighlightBoxOnActiveWord(){
        mActiveWord.showHighlightBox();
    }

    // FTR_AUDIO_SPACE&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_1|FTR_AUDIO_SPACE&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_2|FTR_AUDIO_SPACE&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_3|FTR_AUDIO_PUNC&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_1|FTR_AUDIO_PUNC&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_2|FTR_AUDIO_PUNC&FTR_SEN_WRD&FTR_HESITATION_2&FTR_ATTEMPT_3
    // FTR_SEN_WRD&FTR_HESITATION_3&FTR_ATTEMPT_1|FTR_SEN_WRD&FTR_HESITATION_3&FTR_ATTEMPT_2|FTR_SEN_WRD&FTR_HESITATION_3&FTR_ATTEMPT_3
    // FTR_AUDIO_SPACE&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_1|FTR_AUDIO_SPACE&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_2|FTR_AUDIO_SPACE&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_3|FTR_AUDIO_PUNC&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_1|FTR_AUDIO_PUNC&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_2|FTR_AUDIO_PUNC&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_3
    // FTR_SEN_SEN&FTR_HESITATION_3&FTR_SEN_ATTEMPT_1|FTR_SEN_SEN&FTR_HESITATION_3&FTR_SEN_ATTEMPT_2|FTR_SEN_SEN&FTR_HESITATION_3&FTR_SEN_ATTEMPT_3
    ...
    // FTR_SEN_COPY&FTR_SEN_LTR&FTR_HESITATION_2|FTR_SEN_CORR&FTR_SEN_LTR&FTR_HESITATION_2
    ...
    // !FTR_AUDIO_SPACE&!FTR_AUDIO_PUNC&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_1|!FTR_AUDIO_SPACE&!FTR_AUDIO_PUNC&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_2|!FTR_AUDIO_SPACE&!FTR_AUDIO_PUNC&FTR_SEN_SEN&FTR_HESITATION_2&FTR_SEN_ATTEMPT_3
    ...
    // FTR_SEN&FTR_SEN_WRD&FTR_ATTEMPT_4
    // FTR_SEN&FTR_SEN_WRD&FTR_ATTEMPT_4
    // FTR_SEN&FTR_SEN_SEN&FTR_ATTEMPT_4
    ...
    public void deleteItem(View child) {
        ...
        if(activityFeature.contains(WR_FEATURES.FTR_SEN_LTR)){
            if (isComplete()) {
                applyBehavior(WR_BEHAVIORS.DATA_ITEM_COMPLETE); // goto node "ITEM_COMPLETE_BEHAVIOR" -- run when item is complete...
            }
        }
    ...
    public void addItemAt(View child, int inc) {
        ...
        if (activityFeature.contains(WR_FEATURES.FTR_SEN_COPY)) {
            v.showDeleteSpaceButton(true);
            v.showInsLftButton(true);
            v.showInsRgtButton(true);
        } else if (activityFeature.contains(WR_FEATURES.FTR_SEN_CORR)) {
        ...
        if (!activityFeature.contains(WR_FEATURES.FTR_SEN_CORR)) {
     ...
     * TODO: clean this up, we shouldn't have one method with 600 lines of code
     *
     * @param glyphController
    ...
    public boolean updateStatus(IGlyphController glyphController, CRecResult[] _ltkPlusCandidates) {
        ...
        publishValue(WR_VALUES.CANDIDATE_VAR, candidate.getRecChar().toLowerCase());
        publishValue(WR_VALUES.EXPECTED_VAR, mActiveController.getExpectedChar().toLowerCase());


        // Avoid caseSensitive for words activity
        boolean isAnswerCaseSensitive = true;
        boolean isWordActivity = activityFeature.contains(WR_FEATURES.FTR_WORDS);
        boolean isMissingLtrActivity = activityFeature.contains(WR_FEATURES.FTR_MISSING_LTR);
        ...
        // for sentence activities (word level and sentence level feedback)
            ...
            updateStatusForSentence(gController);
        }
        return _isValid;
    }

    /**
     * perform UpdateStatus logic for data sources that are non-sentence-writing tutors
     * @param stimController
     */
    private void updateStatusForNonSentence(CStimulusController stimController) {
        ...
        if (isComplete()) {
            ...
            if (!_isValid) {
                ...
                publishFeature(WR_FEATURES.FTR_HAD_ERRORS);

                int attempt = updateAttemptFeature();

                if (attempt > 4) {
                    applyBehavior(WR_BEHAVIORS.MERCY_RULE); // goto node "MERCY_RULE_BEHAVIOR"
                } else {
                    applyBehavior(WR_BEHAVIORS.ON_ERROR); // goto node "GENERAL_ERROR_BEHAVIOR"
                }

                if (!_charValid)
                    applyBehavior(WR_BEHAVIORS.ON_CHAR_ERROR);
                else if (!_metricValid)
                    applyBehavior(WR_BEHAVIORS.ON_METRIC_ERROR);
            } else {
                updateStalledStatus();

                applyBehavior(WR_BEHAVIORS.ON_CORRECT); //goto node "GENERAL_CORRECT_BEHAVIOR"
            }
        }
    }

    /**
     * perform UpdateStatus logic for data sources that are sentence-writing tutors
     * @param gController
     */
    private void updateStatusForSentence(CGlyphController gController) {
                ...
                if(canReplace) {
                    ...
                    if(responseEqualsTargetReplacement){
                        ...
                        if (writtenSentenceIsCorrect) {
                            ...
                            applyBehavior(WR_BEHAVIORS.DATA_ITEM_COMPLETE);
                        }
                        ...
                        // if the response is correct(item not yet over), check if the word is correct,apply ON_CORRECT
                            ...
                            if (wordIsCorrect) {
                                ...
                                publishFeature(WR_FEATURES.FTR_WORD_CORRECT);
                                temporaryOnCorrect();
                                applyBehavior(WR_BEHAVIORS.ON_CORRECT);
                            }
                        ...
                        // if the response is correct at the right place, but there are more corrections to be made, check if the word is correct, turn blue depending on what the attempt level of that sentence is.
                            ...
                            if(currentWordIndex != -1) { //when the replacement is in a word
                                ...
                                if (writtenWordIsCorrect) {
                                    publishFeature(WR_FEATURES.FTR_WORD_CORRECT);
                                    applyBehavior(WR_BEHAVIORS.ON_CORRECT); //should turn word blue
...
//                                        temporaryOnCorrectSentence();
    ...
    private void updateStalledStatus() {
        ...
        retractFeature(WR_FEATURES.FTR_INPUT_STALLED);
        ...
        if(v != null) {
            ...
            if(!v.getGlyphStarted())
                publishFeature(WR_FEATURES.FTR_INPUT_STALLED);
        }
    }
    ...
    private int updateAttemptFeature() {
        ...
        if(activityFeature.contains(WR_FEATURES.FTR_SEN_WRD)){
            attempt = mActiveWord.incAttempt();
        }
        else if(activityFeature.contains(WR_FEATURES.FTR_SEN_SEN)){
            attempt = mActiveWord.incAttempt();
        }
        else{
...
//        deactivateEditModeInActiveWord();  //edit buttons removed for code drop 2 in tanzania
    ...
    public void evaluateSentenceWordLevel(){
        ...
        //sentence not finished.
            ...
            for(int i = currentWordIndex; i < mListWordsInput.size(); i++) {
                ...
                boolean wordIsCorrect = mActiveWord.updateInputWordCorrectStatus(i); //checks indices and strings inside
                ...
                //if the word is incorrect, set current word as this, increase attempt if in middle of being written. update colors if
                    ...
                    if (!writingIsContinued) {
                        ...
                        applyBehavior(WR_BEHAVIORS.ON_ERROR);
                    }
    ...
    public void evaluateSentenceFirstTime(){
        ...
        //when the written sentence does not match the expected answer
            ...
            publishFeature(WR_FEATURES.FTR_SEN_EVAL);
            applyBehavior(WR_BEHAVIORS.ON_ERROR); //activates the edit mode.
        }
    }
    //amogh added ends
     ...
     * ( ?? should this be renamed to isWordComplete() ?? )
     *
     * @return
     */
...
//            evaluateSentenceWordLevel();
    ...
    public void rippleReplayActiveIndex(){
        ...
        //if not correct, play replay unless its a space, and update the response, the sentence parameters and the correct status of the glyph
            ...
            if (!isSpaceExpected) {
                v.post(WR_EVENTS.RIPPLE_PROTO);
            }
            else{
//                applyBehavior(WR_BEHAVIORS.FIELD_REPLAY_COMPLETE);
                publishFeature(WR_FEATURES.FTR_SPACE_REPLAY);
                applyBehavior(WR_BEHAVIORS.ON_STOP_WRITING); //added to restart hesitation.
            }
            ...
            applyBehavior(WR_BEHAVIORS.REPLAY_COMPLETE);
    ...
    private void replayNext() {
        ...
        if(activityFeature.contains(WR_FEATURES.FTR_SEN_WRD) || activityFeature.contains(WR_FEATURES.FTR_SEN_SEN)){
    ...
    public void updateText(CWr_Data data) {
        ...
        if (activityFeature.contains(WR_FEATURES.FTR_MISSING_LTR)) {
...
//                mWritingBoxLink.invalidate();
    ...
    public boolean applyBehavior(String event){
        ...
        switch(event) {
            ...
            case WR_EVENTS.FIELD_REPLAY_COMPLETE:
                ...
                if(activityFeature.contains(WR_FEATURES.FTR_SEN_PREFIX)){
                    ...
                    if(activityFeature.contains(WR_FEATURES.FTR_SEN_LTR)){
                        ...
                        //applyBehavior(WR_BEHAVIORS.ON_STOP_WRITING);
                        //vs
                        applyBehavior(WR_BEHAVIORS.ON_ANIMATION_COMPLETE);
...
//                int wid = right-left;
    ...
    public void releaseAudioFeatures(EditOperation e){
        ...
        if(editName.equals("I")){
            ...
            publishFeature(WR_FEATURES.FTR_INSERT);

            //insert spacing
            if(editValue.equals(" ")){
                publishFeature(WR_FEATURES.FTR_AUDIO_SPACE);
            }

            //insert punctuation
            else if (punctuationSymbols.contains(editValue)){
                publishFeature(WR_FEATURES.FTR_AUDIO_PUNC);
                publishFeature(punctuationToFeature.get(editValue));
                publishValue(WR_VALUES.AUDIO_PUNCTUATION, punctuationToString.get(editValue));
            }

            //insert letter
            else{
                publishFeature(WR_FEATURES.FTR_AUDIO_LTR);
                publishValue(WR_VALUES.AUDIO_LETTER, editValue.toUpperCase());
            }
        ...
        //for relacement operation
            ...
            publishFeature(WR_FEATURES.FTR_REPLACE);
            ...
            //replace with an uppercase letter
                ...
                publishFeature(WR_FEATURES.FTR_AUDIO_CAP);
                publishValue(WR_VALUES.AUDIO_LETTER, editValue.toUpperCase());
            }
        ...
        //for delete operation
            ...
            publishFeature(WR_FEATURES.FTR_DELETE);
        ...
        //for none operation
            ...
            publishFeature(WR_FEATURES.FTR_AUDIO_NO_ERROR);
        }
